...
const setupUI = (user) => {
  ...
  //<----------------------Writing to database for LED's & Motor---------------------->
  var led1btn = document.getElementById("LED1btn");
  var led2btn = document.getElementById("LED2btn");
  var led3btn = document.getElementById("LED3btn");
  var motorbtn = document.getElementById("Motorbtn");

  var toggled1 = false; //Variables for LED control
  var toggled2 = false;
  var toggled3 = false;

  var motortoggle = false; //variable for motor toggle

  var LedControlRef1 = firebase.database().ref("LedControl/LED1");
  var LedControlRef2 = firebase.database().ref("LedControl/LED2");
  var LedControlRef3 = firebase.database().ref("LedControl/LED3");
  var MotorControlRef = firebase.database().ref("MotorControl");

  led1btn.addEventListener('click',toggleLED1);
  function toggleLED1(){
    if(!toggled1){
        toggled1 = true;
        document.getElementById("LED1msg").style.display = "none";
        document.getElementById('LED1btn').style.backgroundColor = 'Grey';
        LedControlRef1.set ({
          LED1: 0
        });
        return;
    ...
    if(toggled1){
        toggled1 = false;
        document.getElementById("LED1msg").style.display = "block";
        document.getElementById('LED1btn').style.backgroundColor = 'Green';
        LedControlRef1.set ({
          LED1: 1
        });
        return;
  ...
  led2btn.addEventListener('click',toggleLED2);
  function toggleLED2(){
    if(!toggled2){
        toggled2 = true;
        document.getElementById("LED2msg").style.display = "none";
        document.getElementById('LED2btn').style.backgroundColor = 'Grey';
        LedControlRef2.set ({
          LED2: 0
        });
        return;
    ...
    if(toggled2){
        toggled2 = false;
        document.getElementById("LED2msg").style.display = "block";
        document.getElementById('LED2btn').style.backgroundColor = 'Green';
        LedControlRef2.set ({
          LED2: 1
        });
        return;
  ...
  led3btn.addEventListener('click',toggleLED3);
  function toggleLED3(){
    if(!toggled3){
        toggled3 = true;
        document.getElementById("LED3msg").style.display = "none";
        document.getElementById('LED3btn').style.backgroundColor = 'Grey';
        LedControlRef3.set ({
          LED3: 0
        });
        return;
    ...
    if(toggled3){
        toggled3 = false;
        document.getElementById("LED3msg").style.display = "block";
        document.getElementById('LED3btn').style.backgroundColor = 'Green';
        LedControlRef3.set ({
          LED3: 1
        });
        return;
  ...
  function toggleMotor(){
    if(!motortoggle){
        motortoggle = true;
        document.getElementById("Motormsg").style.display = "none";
        document.getElementById('Motorbtn').style.backgroundColor = 'Grey';
        MotorControlRef.set ({
          motor: 0
        });
        return;
    ...
    if(motortoggle){
        motortoggle = false;
        document.getElementById("Motormsg").style.display = "block";
        document.getElementById('Motorbtn').style.backgroundColor = 'Green';
        MotorControlRef.set ({
          motor: 1
        });
        return;
